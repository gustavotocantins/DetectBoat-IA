...
plt.show()
(train_images, train_labels) = load_image_dataset('C:/Users/gusta/Desktop/Novo/Barcos/treino', maxsize)
(test_images, test_labels) = load_image_dataset('C:/Users/gusta/Desktop/Novo/Barcos/teste', maxsize)
